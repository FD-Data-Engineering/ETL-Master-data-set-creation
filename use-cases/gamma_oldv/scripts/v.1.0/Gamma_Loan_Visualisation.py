...
cos = getCOSconfig()
itemList = getBucketContents(cos,"publishedgammadata",["20230217","csv"])
dataDict =  getCSVFromBucket(cos,"publishedgammadata",itemList)
...
df_gamma_loan = getCSVdf(dataDict)
...
sligo_ber.save('Sligo_Energy_Rating.html')
bucket = cos.Bucket("publishedgammadata")
obj = bucket.Object('visualization/Sligo_Energy_Rating.html')

with open('Sligo_Energy_Rating.html', 'rb') as sligo_ber:
    obj.upload_fileobj(sligo_ber)
...
sligo_flood.save('Sligo_Flood_Rating.html')
bucket = cos.Bucket("publishedgammadata")
obj = bucket.Object('visualization/Sligo_Flood_Rating.html')

with open('Sligo_Flood_Rating.html', 'rb') as sligo_flood:
    obj.upload_fileobj(sligo_flood)
...
Sligo_gamma_loan.save('Sligo_Gamma_Loan_IndexSearch.html')
bucket = cos.Bucket("publishedgammadata")
obj = bucket.Object('visualization/Sligo_Gamma_Loan_IndexSearch.html')

with open('Sligo_Gamma_Loan_IndexSearch.html', 'rb') as Sligo_gamma_loan:
    obj.upload_fileobj(Sligo_gamma_loan)
